  ...
  return (
    <>
      <div className="flex flex-col pb-8 bg-primary-50">
        <div className="pb-4 mt-8 text-left ml-44 text-7xl font-body">Contact</div>
        <div className="flex flex-row justify-evenly">
          ...
          <div className="flex flex-col">
            <div className="mt-2 text-3xl ml-44 w-96">
            ...
            <div className="flex flex-row justify-center mt-1 text-3xl">
            ...
            <div className="mt-1 text-3xl ml-44 w-96">
              <div className="py-6 bg-primary-300 rounded-xl">
