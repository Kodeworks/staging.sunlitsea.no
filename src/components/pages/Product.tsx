      ...
      <div className="flex flex-col px-32 pb-24 whiteSecondaryGradient">
        <section className="flex flex-row mt-16 ml-8">
          <div className="flex flex-col">
            ...
            <div className="mt-8 ml-8 text-3xl">
          ...
          <img src={'/img/panels.png'} className="w-1/2 px-8" alt="Floating solar panels" />
        </section>
        <section className="flex flex-row mt-16">
          <img className="w-1/2 mx-4" src={'/img/video_placeholder.png'} alt="Deployment video" />
        ...
        <section className="flex flex-col mt-24">
          ...
          <div className="flex flex-col w-9/12 ml-16 text-3xl">
        ...
        <section className="flex flex-col pb-24 mt-24">
          <div className="flex flex-row justify-between">
            ...
            <div className="flex flex-col w-1/2 mt-8">
              ...
              <div className="mt-4 ml-16 text-3xl">
