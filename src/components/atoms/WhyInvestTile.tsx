...
const WhyInvestTile: React.FC<Props> = ({ name, number }) => {
  return (
    <div className="px-2 xl:px-4 2xl:px-8 py-4  bg-primary-100 lg:h-[240px] w-full sm:w-auto  sm:max-w-[280px] md:max-w-full min-w-[150px] lg:min-w-[190px] xl:min-w-[220px] 2xl:min-w-[300px]">
      <div className="">
